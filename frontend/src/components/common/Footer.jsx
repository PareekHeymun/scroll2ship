...
export default function Footer(){
    ...
    return(
        <>
            <div style={{height:"550px",width:"100%",backgroundColor:"#141414ff",color:"white",display:"flex",flexDirection:"column",border:"0",position:"relative"}}>
                ...
                <nav style={{display:'flex',flexDirection:'row', gap:'250px',transform:"translate(30px,200px)"}}>
                    <div style={{height:"parent",display:'flex',flexDirection:'column'}}>
                        <h1>Quick Links</h1>
                        <p>About</p>
                        <p>Our story</p>
                        <p onClick={()=>navigate('/')}>Home</p>
                    </div>
                    <div style={{height:"parent",display:'flex',flexDirection:'column',aligncontent:'center'}}>
                        <h1>Account</h1>
                        <p>Login/SignUp</p>
